    ...
    <div class="container">
        <form class="ma" action="${pageContext.request.contextPath}/user/resetPassword">
            ...
            <div class="form_header">
                <div class="form_title"><h2>重置密码</h2></div>
            </div>
            <div class="form_body">
                <input type="password" id="password" name="password" placeholder="请输入新密码"/>
                <input type="password" id="password02" name="password02" placeholder="再次输入新密码" style="width:100%"/>
                <span id="passMsg"></span>
                <input type="submit" onclick="return commitForm()" style="margin:0px;width:100%" value="提交"/>
            </div>
        </form>
    </div>
</main>
