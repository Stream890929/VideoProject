...
<body>
<header>
    <div class="container"><img src="${pageContext.request.contextPath}/img/logo.png" alt="小禅院"/></div>
</header>

<main>
    <div class="container">
        <form action="${pageContext.request.contextPath}/user/validateEmailCode" class="ma">
            <div class="form_header">
                <div class="form_title"><h2>忘记密码</h2><span>通过注册邮箱和手机号重设密码</span></div>
                <div class="form_back"><a href="${pageContext.request.contextPath}/index.jsp">返回立即登录</a></div>
            </div>
            <div class="form_body">
            ...
            <div class="form_footer">
                <div class="FAQ"><span>收不到邮件？查看</span><a href="#">常见问题</a></div>
            </div>
        </form>
    </div>
</main>
