...
<header>
    <div class="container top_bar clearfix">
        ...
        <div id="tele"><span>0375-208-9092</span><span>0375-208-9051</span></div>
    </div>
    <menu>
        <div class="container clearfix">
            <ul class="clearfix f_left">
                ...
                <li class="menu_active">
                    <a href="${pageContext.request.contextPath}/user/showMyProfile">个人中心</a>
                </li>
            </ul>
            <div id="search_group">
                <input type="text" placeholder="搜索课程"><span id="search"></span>
            </div>
            <div id="user_bar">
                <a href="${pageContext.request.contextPath}/user/showMyProfile">
                    <c:if test="${empty user.imgurl}">
                        <img src="${pageContext.request.contextPath}/img/avatar_lg.png" id="avatar" alt=""/>
                    </c:if>

                    <c:if test="${not empty user.imgurl}">
                        <img src="${user.imgurl}" id="avatar" alt=""/>
                    </c:if>
                </a>
            ...
            <div class="proflle_tab_body">
                ...
                <div class="proflle_tab_workplace clearfix">
                    <div class="profile_avatar_area">
                        <c:if test="${empty user.imgurl}">
                            <img src="${pageContext.request.contextPath}/img/avatar_lg.png" id="avatar" style="width:180px; height:180px;" alt=""/>
                        </c:if>

                        <c:if test="${not empty user.imgurl}">
                            <img src="${user.imgurl}" id="avatar" style="width:180px; height:180px;" alt=""/>
                        </c:if>
                    </div>
                    <div class="profile_ifo_area">
                        <form action="${pageContext.request.contextPath}/user/updateUser">
                            ...
                            <div class="form_group">
                                ...
                                <input type="radio" id="man" name="sex" value="man"/><label for="man">男</label>
                                <input type="radio" id="woman" name="sex" value="woman"/><label for="woman">女</label>
                            </div>
                            <div class="form_group">
                            ...
                            <div class="form_group">
                                <span class="dd">邮&#x3000;箱：</span><span>${user.email}</span>
                            </div>
                            <div class="form_group">
                                <span class="dd">所在地：</span>
                                <div id="city">
                                    <select name="prov" class="prov"></select>
                                    <select name="city" disabled="disabled" class="city"></select>
                                </div>
...
<footer>
    <div class="container">
        <ul>
            <li><img src="${pageContext.request.contextPath}/img/footer_logo.png" id="foot_logo" alt=""/></li>
            <li>版权所有：Y先生教育&#x3000;&#x3000;&#x3000;&copy;&nbsp;www.chengjian100.com</li>
            <li><img src="${pageContext.request.contextPath}/img/微信公众号.png" id="wxgzh" alt=""/></li>
        </ul>
    </div>
</footer>
