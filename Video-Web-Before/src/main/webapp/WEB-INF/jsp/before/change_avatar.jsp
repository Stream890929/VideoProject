    ...
    <div class="container">
        ...
        <div id="profile_tab">
            ...
            <div class="proflle_tab_body">
                <h3><a href="./my_profile.jsp">返回个人中心</a></h3>
                <div class="proflle_tab_workplace clearfix">
                    <div class="profile_avatar_area">
                        ...
                        <c:if test="${not empty user.imgurl}">
                            <img src="${user.imgurl}" style="width:200px; height:200px;"/>
                        </c:if>
                        <p style="text-align: center;">当前头像</p>
                    </div>
                    <div class="profile_ifo_area">
                        <form action="${pageContext.request.contextPath}/user/upLoadImage" id="upload_form"
                            ...
                            <p>第一步：请选择图像文件</p>
                            <div>
                                <input type="file" id="image_file" name="image_file" onchange="fileSelectHandler()"/>
                            </div>
                            <div class="error"></div>
