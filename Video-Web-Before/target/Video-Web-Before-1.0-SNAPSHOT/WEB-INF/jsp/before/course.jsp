    ...
    <div class="container">
        ...
        <div id="userBlock" style="display:none;float:right">
            ...
            <a href="${pageContext.request.contextPath}/user/showMyProfile"
               id="account">${sessionScope.userAccount}</a>
        </div>
        ...
        <ul class="text_13 f_right">
            ...
            <li class="nav_down">高端课程
                ...
                <ul id="nav_down" class="t_center">
                    ...
                    <li><a target="_blank" href="http://www.chengjian100.com/IS/index.html">信息安全</a></li>
        ...
        <div class="container">
            ...
            <c:forEach items="${subject.courseList}" var="course">
                <div class="section">
                    ...
                    <div class="kcIntro">
                        <p class="int"><span>课程介绍：</span>${course.courseDesc}</p>
                    </div>
                    <ul>
                        <!--节-->
                            ...
                            <li class="section-main" onclick="getVideo(${video.id})">
                                ...
                                <div class="classify-v-info">
                                    ...
                                    <span class="duration" title="视频时长">
                                        <img src="${pageContext.request.contextPath}/img/player.png" alt=""/>
                                            ${video.showTime}
                                    </span>
                                </div>
                            </li>
...
<footer>
    <ul>
        <li><img src="${pageContext.request.contextPath}/img/footer_logo.png" alt="" draggable="false"></li>
        <li class="mt25">
            <h3>校区地址</h3>
            <ul><li>地址<br>河南省平顶山市新华区龙翔大道河南小禅院学院</li></ul>
        </li>
        <li class="mt25">
            <h3>联系我们</h3>
            <ul id="foo_icon">
...
<div class="mask hidden" id="reg">
    <div class="mask_content">
        ...
        <div class="mask_content_body">
            <form action="insertUser" id="regForm">
                <h3>新用户注册</h3>
