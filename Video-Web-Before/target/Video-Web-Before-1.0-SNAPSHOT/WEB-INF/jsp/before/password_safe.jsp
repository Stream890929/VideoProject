        ...
        $(function () {
            $("#oldPassword").blur(function () {
                ...
                if (null != oldPass && oldPass != "") {
                    ...
                    $.post("validatePassword", params, function (data) {
                        if (data == "success") {
...
<header>
    ...
    <menu>
        <div class="container clearfix">
            ...
            <div id="search_group"><input type="text" placeholder="搜索课程"/><span id="search"></span></div>
            <div id="user_bar">
                    ...
                    <div class="profile_ifo_area">
                        <form action="updatePassword">
                            ...
                            <div class="form_submit dd">
                                <input type="submit" value="保&#x3000;存"/><a href="#">取消</a>
                            </div>
                        </form>
                    </div>
                </div>
