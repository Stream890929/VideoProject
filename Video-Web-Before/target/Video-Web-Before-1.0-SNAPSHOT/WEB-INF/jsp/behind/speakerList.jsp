        ...
        function delSpeakerById(Obj, id, name) {
            Confirm.show('温馨提示：', '确定要删除' + name + '么？', {
                'Delete': {
                    ...
                    'callback': function () {
                        var param = {"id": id};
                        $.post("${pageContext.request.contextPath}/speaker/deleteSpeaker", param, function (data) {
                            if (data == 'success') {
...
<div class="jumbotron" style="padding-top: 15px;padding-bottom: 15px;">
    <div class="container"><h2>主讲人管理</h2></div>
</div>
    ...
    <table class="table table-bordered table-hover" style="text-align: center;table-layout:fixed;">
        ...
        <c:forEach items="${pageInfo.list}" var="speaker" varStatus="status">
            <tr>
                ...
                <td><a href="${pageContext.request.contextPath}/speaker/editSpeaker/${speaker.id}">
                    <span aria-hidden="true" class="glyphicon glyphicon glyphicon-edit"></span></a></td>
                <td><a href="#" onclick="return delSpeakerById(this,'${speaker.id}','${speaker.speakerName}')">
